            ...
            <div class="card w-100">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        ...
                        <p class=""><a class="btn btn-primary" href="{{ route('admin-movie-create') }}"><i class="fa fa-plus"></i> Add New Movie</a>
                        </p>
                    </div>
                    <div class="row">
                        <div class="col-12">
                                        ...
                                        @foreach ($movies as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{ route('admin-movie-delete', $item->id) }}"
                                                        onclick="return confirm('Are you sure you want to delete this item?');"><i
                                                            class="fa fa-trash text-danger"
                                                            aria-hidden="true"></i></a>&nbsp;&nbsp;
                                                    <a href="{{ route('admin-movie-save', base64_encode($item->id)) }}"><i

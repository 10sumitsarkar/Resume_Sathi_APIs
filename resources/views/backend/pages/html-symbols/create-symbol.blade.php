                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <div class="col">
                                <label>UNICODE</label>
                                <div id="the-basics">
                                    <input class="typeahead" type="text" placeholder="UNICODE" value="{{old('unicode')}}" name="unicode">
                                </div>
                            </div>
                            <div class="col">
                                <label>HEX CODE</label>
                                <div id="bloodhound">
                                    <input class="typeahead" type="text" placeholder="HEX CODE" value="{{old('hex_code')}}" name="hex_code">
                                </div>
                            </div>
                            <div class="col">
                                <label>HTML CODE</label>
                                <div id="the-basics">
                                    <input class="typeahead" type="text" placeholder="HTML CODE" value="{{old('html_code')}}" name="html_code">
                                </div>
                            </div>
                            <div class="col">
                                <label>HTML ENTITY</label>
                                <div id="bloodhound">
                                    <input class="typeahead" type="text" placeholder="HTML ENTITY" value="{{old('html_entity')}}" name="html_entity">
                                </div>
                            </div>
                            <div class="col">
                                <label>CSS CODE</label>
                                <div id="the-basics">
                                    <input class="typeahead" type="text" placeholder="CSS CODE" value="{{old('css_code')}}" name="css_code">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <div class="col">
                                ...
                                <div id="the-basics">
                                    <input class="typeahead" type="text" placeholder="Symbol name here..." value="{{old('name')}}" name="name" required>
                                </div>
                            </div>
                            <div class="col">
                                <label>URL Name<span
                                    class="text-danger">*</span></label>
                                <div id="the-basics">
                                    <input class="typeahead" type="text" placeholder="URL name here..." value="{{old('url_name')}}" name="url_name" required>
                                </div>
                            </div>
                            <div class="col">
                                ...
                                <div id="bloodhound">
                                    <div class="form-group">
                                        <select class="js-example-basic-single w-100" required value="{{old('category_id')}}" name="category_id">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="MetaTitle" value="{{old('meta_title')}}" name="meta_title" value=""
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="MetaDescription" value="{{old('meta_description')}}" name="meta_description"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="MetaKeyword" value="{{old('meta_keyword')}}" name="meta_keyword"

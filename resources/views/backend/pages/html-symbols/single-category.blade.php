            ...
            <form method="POST" class="col-lg-12" enctype="multipart/form-data">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-3 col">
                                <div class=" float-right">
                                    <input class="form-check-input" name="is_active" type="checkbox" role="switch" id="activeCheck" {{ $category->is_active ? 'checked' : '' }}>
                        ...
                        <div class="form-group row">
                            <label for="URLTitle" class="col-sm-3 col-form-label">Category URL<span
                                    class="text-danger">*</span></label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="URLTitle" name="url_name" value="{{$category->url_name}}"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="MetaTitle" name="meta_title" value="{{$category->meta_title}}"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="MetaDescription" name="meta_description"
                                    value="{{$category->meta_description}}" placeholder="Meta description here...">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="MetaKeyword" name="meta_keyword"
                                    value="{{$category->meta_keyword}}" placeholder="Meta keyword here...">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="categorySymbol" name="symbol"
                                    value="{{$category->symbol}}" placeholder="Category Symbol here..." required>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="categorydescription" name="description"
                                    value="{{$category->description}}" placeholder="Category description here..." >
                            </div>
                        </div>
                        <br>

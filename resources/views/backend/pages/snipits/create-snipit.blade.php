                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-9 col">
                                <h4 class="card-title">Web Development Snipit</h4>
                            </div>
                            <div class="col-md-3 col">
                                <div class=" float-right">
                                    <input class="form-check-input" name="is_active" type="checkbox" role="switch" id="activeCheck" {{ $snipit->is_active ? 'checked' : '' }}>
                                    <label class="form-check-label" for="activeCheck">Active</label>
                                </div>
                                <div class="">
                                    <input class="form-check-input" name="is_draft" type="checkbox" role="switch" id="draftCheck" {{ $snipit->is_draft ? 'checked' : '' }}>
                        ...
                        <h4 class="card-title">Snipit Codes</h4>
                        <div class="form-group row">
                            <label for="snipitName" class="col-sm-3 col-form-label">HTML Code<span class="text-danger">*</span></label>
                            <div class="col-sm-9">
                                   <textarea name="html" rows="10" required class="form-control">
                                    @if ($snipit->codes)
                                    {{$snipit->codes->html}}
                                    @else
                                    Edit your html here...
                        ...
                        <div class="form-group row">
                            <label for="snipitName" class="col-sm-3 col-form-label">CSS Code<span class="text-danger"></span></label>
                            <div class="col-sm-9">
                                   <textarea name="css"  rows="10" class="form-control">
                                    @if ($snipit->codes)
                                    {{$snipit->codes->css}}
                                    @else
                                    Edit your css here...
                        ...
                        <div class="form-group row">
                            <label for="snipitName" class="col-sm-3 col-form-label">Javascript Code<span class="text-danger"></span></label>
                            <div class="col-sm-9">
                                   <textarea name="javascript"  rows="10" class="form-control">
                                    @if ($snipit->codes)
                                    {{$snipit->codes->javascript}}
                                    @else
                                    Edit your javascript here...
                                    @endif
                                </textarea>
                            </div>
                        </div>
                        <br>
                        <h4 class="card-title">Snipit Detail</h4>
                        <div class="form-group row">
                            <label for="snipitName" class="col-sm-3 col-form-label">Snipit Title<span class="text-danger">*</span></label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="snipitName" name="title"
                                   value="{{ $snipit->title }}" required placeholder="Snipit title here...">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="URLTitle" class="col-sm-3 col-form-label">Snipit URL<span class="text-danger">*</span></label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="URLTitle" name="url_name"
                                 value="{{ $snipit->url_name }}" required  placeholder="URL title here...">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="MetaTitle" name="meta_title"
                                 value="{{ $snipit->meta_title }}"   placeholder="Meta title here...">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="MetaDescription" name="meta_description"
                                   value="{{ $snipit->meta_description }}" placeholder="Meta description here...">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="MetaKeyword" name="meta_keyword"
                                   value="{{ $snipit->meta_keyword }}" placeholder="Meta keyword here...">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-3 col-form-label">Select Snipit Category</label>
                            <div class="col-sm-9">
                                <select class="js-example-basic-single w-100" name="snipit_type">
                                @foreach ($snipit_category as $item)
                                @if (intval($snipit->snipit_category) === intval($item->id))
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                ...
                                <div class="pt-2 w-100" >
                                    @if ($snipit->hero_image)
                                    <div class="float-left" id="previewTitle" style="display: none">
                                        <h5>Preview Hero Image : </h5>
                                    </div>
                                    <img src="{{ asset($snipit->hero_image) }}" class="float-right  w-50" id="uploadPreview" alt="Hero Image">
                                    @else
                                    <div class="float-left" id="previewTitle" style="display: none">
                                        <h5>Preview Hero Image : </h5>
                                    </div>
                        ...
                        <br>
                        <input type="hidden" name="snipit_id" value="{{ $snipit->id }}">
                    ...
                    <div class="card-body">
                        ...
                        <div class="attachmentDiv">
                            ...
                            <div class="row attachmentList">
                                <div class="col-12">
                                    <h4>Uploaded Attchements (<span id="totalAttachment">{{ count($snipit->attachments) }}</span>)</h4>
                                </div>
                                <div class="col-12" id="attachmentList">
                                    @foreach ($snipit->attachments as $attachment)
  ...
  <script src="{{ asset('dashboard-assets/js/jquery.min.js') }}"></script>
    <script>
        ...
        $('#attachment_form').on('submit', (e) => {
            ...
            formData.append('action_id' , snipit_id);
            formData.append('file_type' , file_type);
            formData.append('attachment_for' , 'snipit');
            $.ajax({
                cache: false,
                contentType: false,
                processData: false,
        ...
        function removeAttachment(id){
            ...
            $.ajax({
                type:'post',
                data:{id:id, attachment_for:'snipit'},

                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-9 col">
                                ...
                                <p><a href="{{ route('tutorials') }}">View all tutorial</a></p>
                            </div>
                        </div>

                        <div class="form-group row">
                            <label for="CourseName" class="col-sm-3 col-form-label">Title<span class="text-danger">*</span></label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="CourseName" name="title" value="{{ old('title') ? old('title') : $tutorial->title }}"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="URLName" name="url_name" value="{{ old('url_name') ? old('url_name') : $tutorial->url_name }}"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                ...
                                <div class="pt-2 w-100" >
                                    ...
                                    <img src="{{ asset($tutorial->image) }}" class="float-right  w-50" id="uploadPreview" alt="Hero Image">
                                    @else
                                    <div class="float-left" id="previewTitle" style="display: none">
                                        <h5>Preview Hero Image : </h5>
                                    </div>

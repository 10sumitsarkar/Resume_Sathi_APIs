                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="CourseName" name="title" value="{{ old('title') }}"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="URLName" name="url_name" value="{{ old('url_name') }}"

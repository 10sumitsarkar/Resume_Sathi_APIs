                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="CourseName" name="course_name" value="{{ $category->course_name }}"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="CourseURL" name="course_url" value="{{ $category->course_url }}"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="CourseDescription" name="description"  value="{{ $category->description }}"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                ...
                                <div class="pt-2 w-100" >
                                    ...
                                    <img src="{{ asset($category->course_image) }}" class="float-right  w-50" id="uploadPreview" alt="Hero Image">
                                    @else
                                    <div class="float-left" id="previewTitle" style="display: none">
                                        <h5>Preview Hero Image : </h5>
                                    </div>

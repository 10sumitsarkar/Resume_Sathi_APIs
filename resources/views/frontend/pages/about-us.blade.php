...
@section('canonical', 'https://www.w3coderschool.com/about-us')
...
@section('og-url', 'https://www.w3coderschool.com/about-us')

@section('content')
    <!-- Header Start -->
    <div class="common-container text-center pt-5">
        <h1 class="topics-heading pb-3">About <span>Us</span></h1>
        <p class="topics-heading-para">Welcome to W3coderschool, your go-to destination for knowledge, skills, and innovation. We
        ...
        <div class="container-fluid common-container py-5">
            <div class="row d-lg-flex align-items-center">
                ...
                <div class="col-lg-6 mt-3 mt-lg-0">
                    ...
                    <p class="para">At w3coderschool, our mission is clear: to make learning accessible, engaging, and
            ...
            <div class="row d-lg-flex align-items-center">
                <div class="col-lg-6 mt-3 mt-lg-0">
                    ...
                    <ul class="what-weoffer-list">
                        ...
                        <li><strong>Community and Support:</strong> w3coderschool is more than just a platform; it's a
    ...
    <section class="each-category-section">
        <div class="container-fluid common-container py-5">
            <div class="row d-lg-flex align-items-center">
                ...
                <div class="col-lg-6 mt-3 mt-lg-0">
                    <h2>Why Choose<span> w3coderschool?</span></h2>
                    <ul class="what-weoffer-list">
                        ...
                        <li><strong>Career Advancement:</strong> Whether you're seeking a career change or advancement in
                            your current field, w3coderschool can help you achieve your goals.</li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="common-container py-50 pt-4 ">
        <div class="about-join-us px-3">
            ...
            <p class="px-0 px-md-5 mt-3 mb-0">No matter where you are in your educational or professional journey,
                w3coderschool is here to support you. Together, we can embark on a lifelong quest for knowledge, innovation,

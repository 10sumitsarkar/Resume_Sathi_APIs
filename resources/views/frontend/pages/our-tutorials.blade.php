...
@section('content')
 ...
 <div class="common-container pt-5">
    <h1 class="topics-heading" >{{ $language ? $language->title : 'Our' }} <span>Tutorial</span></h1>
</div>
<!-- Header End -->
        ...
        <div class="row">
                ...
                <div class="container-fluid px-0">
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-lg-6 col-xl-4 mb-4 each-post-parent">
                            <a href="{{ url($article->canonical_tag) }}" class="each-posts-card" aria-label="{{ $language ? $language->title : 'Our' }} Tutorial">
                                <div class="img-div">
                                    <img loading="lazy" src="{{ asset($article->hero_image) }}" class="img-fluid" alt="{{ $article->article_title }}" title="{{$language}} Tutorial">
            ...
            <div class="col-lg-4 col-xl-3">
                ...
                <!-- Tutorial categories end -->
                 ...
                 @include('frontend.layout.inc.sidebar-components.popular-snippets')

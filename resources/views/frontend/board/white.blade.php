...
<head>
    ...
    <title>Whiteboard Tool Online</title>
    <meta charset="utf-8">
    ...
    <link rel="stylesheet" href="{{ asset('white-board-assets/material.css') }}">
    <link rel="stylesheet" href="{{ asset('white-board-assets/text-editor.css') }}">
    <link rel="stylesheet" href="{{ asset('white-board-assets/deskof.css') }}">
    <script src="{{ asset('white-board-assets/jquery.min.js') }}"></script>
    <script src="{{ asset('white-board-assets/easy-ui.min.js') }}"></script>
...
<body>
    <!-- Loader html code -->
    <div class="cursor-pointer" id="cursor-pointer"><i class="fas fa-mouse-pointer"></i></div>
    <div class="eraser-cursor" id="eraser-cursor"><i class="fa fa-eraser"></i></div>
    <!-- end of Loader html code -->
    <div id="block" class="easyui-window" title=""
        data-options="modal:true,closed:true, draggable:false, resizable:false" style="width:100%;height:100%;">
    </div>
    </div>
            ...
            <div class="db-nav">
                <ul>
                    <li><a href="javascript:void(0);" id="ancDrawing" title="Drawing Mode">
                            <div class="sub-default-lft" style="border-right:none;"><i
                                    class="fa-sharp fa-regular fa-shapes"></i></div>
                        </a></li>
                    <li><a href="javascript:void(0);" id="ancEditor" title="Editor Mode">
                            <div class="sub-default-lft" style="border-right:none;"><i
                                    class="fa-sharp fa-regular fa-pen-to-square"></i></div>
                        </a></li>
                    <li><a href="javascript:void(0);" id="ancHelp" title="Help">
                            <div class="sub-default-lft" style="border-right:none;"><i
                                    class="fa-sharp fa-regular fa-square-question"></i></div>
                        </a></li>
                </ul>
            </div>
...
-->
        ...
        <div id="west" data-options="region:'west', title:'',iconCls:'', split:false, collapsible:false"
            style="background-color: #fbe3e8;border: 1px solid #fbe3e8;">
            <div class="wr-left" id="toolbox">
                <div class="wr-lft-cont column">
                    <div class="sub-default clickDisable" id="lftMainmenu">
                        <a href="javascript:void(0);" id="ancSelect" title="Select Tool">
                            <div class="sub-default-lft"><i class="fa-duotone fa-arrow-pointer"></i></div>
                        </a>
                        <a href="javascript:void(0);" id="ancAddBoard" title="Add New Board">
                            <div class="sub-default-lft"><i class="fa-duotone fa-layer-plus"></i></div>
                        </a>
                        <a href="javascript:void(0);" id="ancPattern" title="Background Image">
                            <div class="sub-default-lft"><i class="fa-duotone fa-grid-round"></i></div>
                        </a>
                        <a href="javascript:void(0);" id="ancColor" title="Pencil Color">
                            <div class="sub-default-lft"><i class="fa-duotone fa-palette"></i></div>
                        </a>
                        <a href="javascript:void(0);" id="ancPencil" title="Select Pencil">
                            <div class="sub-default-lft" style="border-right:none;"><i class="fa-duotone fa-pencil"></i>
                            </div>
                        </a>
                        <a href='javascript:void(0)' id="ancEraser" title="Select Eraser">
                            <div class="sub-default-lft"><i class="fa-duotone fa-eraser"></i></div>
                        </a>
                        <a href="javascript:void(0);" id="ancShape" title="Add Shapes">
                            <div class="sub-default-lft" style="border-right:none;"><i
                                    class="fa-duotone fa-shapes"></i></div>
                        </a>
                        <a href="javascript:void(0);" id="ancText" title="Add Text">
                            <div class="sub-default-lft" style="border-right:none;"><i
                                    class="fa-duotone fa-text"></i></div>
                        </a>
                        <a href="javascript:void(0);" id="ancImage" title="Upload Image">
                            <div class="sub-default-lft" style="border-right:none;"><i
                                    class="fa-duotone fa-image"></i></div>
                        </a>
                        <a href="javascript:void(0);" id="ancDocument" title="Presentation" style="display: none">
                            <div class="sub-default-lft" style="border-right:none;"><i
                                    class="fa-duotone fa-presentation-screen"></i></div>
                        </a>
                        <a href="javascript:void(0);" id="ancDownload" title="Download/Upload">
                            <div class="sub-default-lft" style="border-right:none;"><i
                                    class="fa-duotone fa-display-arrow-down"></i></div>
                        </a>
                        <a href="javascript:void(0);" id="ancUndo" title="Undo">
                            <div class="sub-default-lft" style="border-right:none;"><i
                                    class="fa-duotone fa-rotate-left"></i></div>
                        </a>
                        <a href="javascript:void(0);" id="ancRedo" title="Redo">
                            <div class="sub-default-lft" style="border-right:none;"><i
                                    class="fa-duotone fa-rotate-right"></i></div>
                        </a>
                        <!--
...
-->
                        <a href='javascript:void(0)' title="Clear All" class="clrDynamicCanvas">
                            <div class="sub-default-lft" style="border-right:none;"><i
                                    class="fa-duotone fa-trash-can"></i></div>
                        </a>
                    </div>
                </div>
            </div>
        ...
        <div id="center" data-options="region:'center', split:true"
            style="padding:10px; background:#fbe3e8; padding-top:10px;">
            <div class="wrapLoader" id="wrapLoader">
                <div class="imgLoader">
                    <img src="{{ asset('white-board-assets/images/loading.gif') }}" alt="Loading..." width="70"
                        height="70" />
                    <div id="wait"></div>
                </div>
            </div>
            <div id="stage" class="easyui-panel" data-options="border:false">
                <div id="canvasContainer" data-options="border:false">
                    <div class="canvasClass" id="canvasBoardDiv1">
                        <canvas id="canvasBoard1"></canvas>
                    </div>
                </div>
            </div>

            <div id="editorStage" class="easyui-texteditor" data-options="border:0"
                style="display:none;width:100%;height:100%;border:0px;padding:20px;font-size:20px;font-family:Arial">
            </div>
            ...
            <div class="wr-rgt">
                <div class="wr-rgt-cont">
                    ...
                    <div class="subProperties left-meni-slide" id="bgPattern"
                        style="min-height:312px; max-height:100%;">
                        ...
                        <div class="sub-tools items bgPattern" style="height:375px;">
                            ...
                            <a href="javascript:void(0);" class='bgcrcle'>
                                <input type="color" id="txtBgColorVal" class="form-control picker"
                                    value="#000000">
                            </a>
                            <a href="javascript:void(0);" class='bgcrcle h30' title="Guidelines">
                                <div class="bgclpkr bgpatterns"><img
                                        src="{{ asset('white-board-assets/images/transparent-guidelines.png') }}"
                                        alt="Guidelines" /></div>
                            </a>
                            <a href="javascript:void(0);" class='bgcrcle h30' title="Book Guidelines">
                                <div class="bgclpkr bgpatterns"><img
                                        src="{{ asset('white-board-assets/images/transparent-booklines.png') }}"
                                        alt="Guidelines" /></div>
                            </a>
                            <a href="javascript:void(0);" class='bgcrcle h30' title="Transparent Background">
                                <div class="bgclpkr bgpatterns"><img
                                        src="{{ asset('white-board-assets/images/transparent-checkered.png') }}"
                                        alt="Guidelines" /></div>
                            </a>
                            <a href="javascript:void(0);" class='bgcrcle' title="Transparent Background"
                                ...
                                <form method="post" enctype="multipart/form-data" style="cursor: pointer;">
                                    <input type="file" id="filePattern" name="filePattern"
                                        accept=".jpg,.jpeg,.png" title="Upload Background Image (JPG, JPEG or PNG)" />
                                </form>
                                <div class="fileuploadph" id="btnUploadPattern" title="Upload Pattern from Computer">
                    ...
                    <div class="subProperties left-meni-slide" id="penColorPick"
                        style="min-height:345px; max-height:100%;">
                    ...
                    <div class="subProperties left-meni-slide" id="shapeOptions"
                        ...
                        <div class="sub-tools items">
                            ...
                            <a href="javascript:void(0)" class="" id="shapeRect" title="Rectangle"
                                data-style='rectangle'><i class="fa-sharp fa-regular fa-rectangle"></i></a>
                            <a href="javascript:void(0)" class="" id="shapeSquare" title="Square"
                                data-style='square'><i class="fa-sharp fa-regular fa-square"></i></a>
                            <a href="javascript:void(0)" class="" id="shapeCircle" title="Circle"
                                data-style='circle'><i class="fa-sharp fa-regular fa-circle"></i></a>
                            <a href="javascript:void(0)" class="" id="shapeTriangle" title="Triangle"
                                data-style='triangle'><i class="fa-sharp fa-regular fa-triangle"></i></a>
                            <a href="javascript:void(0)" class="" id="shapeLine" title="Line"
                                data-style='line'><i class="fa-sharp fa-regular fa-grip-lines"></i></a>
                            <a href="javascript:void(0)" class="" id="shapeArrow" title="Arrow"
                                data-style='Arrow'><i class="fa-sharp fa-regular fa-arrow-up-right"></i></a>
                            <a href="javascript:void(0)" class="" id="shapeEllipse" title="Ellipse"
                                data-style='ellipse'><i class="fa-sharp fa-regular fa-circle-ellipsis"></i></a>
                            <a href='javascript:void(0)' class="eraser" id="btnRemoveShape" title="delete">
                                <div class="trash-bgpicker" style="border:none!important;"><i
                                        class="fa-sharp fa-regular fa-trash"></i></div>
                            </a>
                        </div>
                    </div>
                    ...
                    <div id="textOptions" class='subProperties left-meni-slide'
                        style="min-height:135px; max-height:100%;">
                        <div class="icon-curve icon-txtoptions"></div>
                        <div id="dd">
                            <div class="sub-tools items">
                                <a href="javascript:void(0)" id="btnNewText" title="Add New Text"><i
                                        class="fas fa-plus trashh"></i></a>
                                <a href="javascript:void(0)" id="btnRemoveText" title="Delete Text"><i
                                        class="fas fa-trash trashh"></i></a>
                                <a href="javascript:void(0)" id="btnShowMenu" title="Show Text Menu"><i
                                        class="fas fa-bars trashh"></i></a>
                            </div>
                        </div>
                    </div>
                    <!-- End of HTML Text -->
                    ...
                    <div id="imageOptions" class='subProperties left-meni-slide'
                        style="min-height:91px; max-height:100%; ">
                        <div class="icon-curve icon-imgoptions"></div>
                        <div class="sub-tools items" style="height:74px;">
                            <a href="javascript:void(0)" id="btnNewImage" title="Add New Image"><i
                                    class="fa-sharp fa-regular fa-upload"></i></a>
                            <a href="javascript:void(0)" id="btnRemoveImage" class='clsCance'
                                title="Remove Image"><i class="fa-sharp fa-regular fa-trash"></i></a>
                    ...
                    <div id="pdfOptions" class='subProperties left-meni-slide'
                        ...
                        <div class="sub-tools items">
                            <a href="javascript:void(0)" id="btnNewPdf" title="Add New PDF/PPT"><i
                                    class="fas fa-upload trashh" style="font-size:130%!important;"></i></a>
                            <a href="javascript:void(0)" id="btnRemovePdf" class='clsCance'
                                title="Remove PDF/PPT"><i class="fas fa-trash trashh"></i></a>
                            <div class="text-tool sub-tools-cat" id="catOne">
                    ...
                    <div class="subProperties left-meni-slide" id="downloadOptions"
                        ...
                        <div class="sub-tools items" style="height:116px;">
                            <a href='javascript:void(0)' id="ancDwnJson" title="Download as Board"><i
                                    class="fa-sharp fa-regular fa-chalkboard"></i></a>
                            <a href='javascript:void(0)' id="ancDwnJpeg" title="Download as JPEG"><i
                                    class="fa-sharp fa-light fa-file-image"></i></a>
                            <a href='javascript:void(0)'>
                                <form method="post" enctype="multipart/form-data" id="uploadForm">
                                    <div class="fileupload" id="btnUpload" title="Upload Board from Computer"><i
                                            class="fa-sharp fa-regular fa-upload"></i></div>
                    ...
                    <div id="btnDisplayMenu" class="textdisplay">
                        ...
                        <div class="c-two">
                            <div id="alignleft" class="c-two-three divAlign" data-opt="left"><a
                                    href="javascript:void(0);"><i class="fas fa-align-left c-border"></i></a></div>
                            <div id="aligncenter" class="c-two-three divAlign" data-opt="center"><a
                                    href="javascript:void(0);"><i class="fas fa-align-center c-border"></i></a></div>
                            <div id="alignright" class="c-two-three divAlign" data-opt="right"><a
                                    href="javascript:void(0);">
                                    <i class="fas fa-align-right c-border"></i></a></div>
                            <div id="stylebold" class="c-two-three divStyleBold" data-opt="bold"><a
                                    href="javascript:void(0);"><i class="fas fa-bold c-border"></i></a></div>
                            <div id="styleitalic" class="c-two-three divStyleItalic" data-opt="italic"><a
                                    href="javascript:void(0);"><i class="fas fa-italic c-border"></i></a></div>
                        </div>
                        <div class="clear"></div>
                        ...
                        <div class="divider"></div>
                        <div class="c-two">
                            <div class="c-two-three"> <a>Size:</a> <input type="text" id="txtTextSize"
                                    value="20" /> </div>
                            ...
                            <div class="c-two-three" style="width:36%;"> <a>Background:</a>
                                <div class="clear"></div> <input type="color" id="txtBGClrVal"
                                    class="form-control" value="#000000"> <input type="text" id="txtBGHexavalue"
                                    value="#000000" />
                            </div>
                            <div class="clear"></div>
                        </div>
                        ...
                        <div class="c-two">
                            <div class="c-two-two" style="width:99%!important; text-align:left;">
                                <a>Border:</a>
                                <div class="clear"></div>
                                <input type="text" id="txtOutline" value="0"
...
-->
        ...
        <script>
            $(document).ready(function(event) {
                ...
                var currentState = gcanvas.toJSON(['uuid', 'tool', 'hasControls', 'hasBorders', 'selectable',
                    'hoverCursor'
                ]);
                // past states
                var undoStack = [];
                ...
                $('#ancAddBoard').click(function() {
                    ...
                    let board =
                        `<div id="canvasBoardDiv${boardCount}" class="canvasClass" title="Board${boardCount}" style="width:100% !important;height:100% !important;"><canvas style="width:100% !important;height:100% !important;" id="canvasBoard${boardCount}"></canvas></div>`;
                ...
                function saveCurrentState() {
                    ...
                    currentState = gcanvas.toJSON(['uuid', 'tool', 'hasControls', 'hasBorders', 'selectable',
                        'hoverCursor'
                    ]);
                }
                ...
                function changeCanvas(index) {
                    ...
                    gcanvas.on('mouse:down', function(e) {
                        var data = null;
                        if (e.target && e.target.uuid && (drawingTool == DRAWING_SELECT_TOOL || drawingTool ==
                                DRAWING_IMAGE_TOOL || drawingTool == DRAWING_TEXT_TOOL)) {
                            isDrawing = 1;
                            data = {
                        ...
                        if (drawingTool == DRAWING_SELECT_TOOL || drawingTool == DRAWING_IMAGE_TOOL ||
                    ...
                    gcanvas.on('mouse:move', function(e) {
                        var pointer = this.getPointer(e.e);
                        var data = null;
                        if (isDrawing && e.target && e.target.tool && (drawingTool == DRAWING_SELECT_TOOL ||
                                drawingTool == DRAWING_IMAGE_TOOL || drawingTool == DRAWING_TEXT_TOOL)) {
                            data = {
                                pointer: pointer,
                                drawingTool: drawingTool,
                                uuid: e.target.uuid,
                    ...
                    gcanvas.on('mouse:up', function(e) {
                        ...
                        saveCurrentState();
                        if (drawingTool == DRAWING_ERASER_TOOL || drawingTool == DRAWING_PENCIL_TOOL ||
                ...
                $('#filePattern').change(function(e) {
                    ...
                    setTimeout(() => {
                        let imgurl = URL.createObjectURL($('#filePattern')[0].files[0]);
                        setCanvasBackgroundImg(gcanvas, imgurl);
                        gcanvas.renderAll();
                        $('#fileImage').val('');
                        $('#filePattern').val('');
                        $('.subProperties').hide();
                ...
                function DrawArrowMouseMove(pointer) {
                    ...
                    arrowHead.set({
                        ...
                        'angle': FabricCalcArrowAngle(arrowLine.x1, arrowLine.y1, arrowLine.x2, arrowLine.y2)
                    });
                    gcanvas.renderAll();
                }
                ...
                $('.clrDynamicCanvas').click(function() {
                    ...
                    if (gcanvas.getObjects().length > 0) {
                        $.messager.confirm('Confirmation', `Do you really want to clear the board?`, function(
                            r) {
                            if (r) {
                                gcanvas.clear();
                                gcanvas.setBackgroundImage('');
                                ...
                                gcanvas.freeDrawingBrush.width = pencilWidth;
                                gcanvas.freeDrawingCursor = 'url(' + pencilCursorURL + ') 0 30, auto';
                                currentState = gcanvas.toJSON(['uuid', 'tool', 'hasControls',
                                    'hasBorders', 'selectable', 'hoverCursor'
                                ]);
                                saveCurrentState();
                            }
                        });
                ...
                function addTextObject(uuid) {
                    ...
                    var textString = 'This is simple text which can be edited\nas per your requirements';
                ...
                $('#fileImage').change(function(e) {
                    ...
                    setTimeout(() => {
                        let imgurl = URL.createObjectURL($('#fileImage')[0].files[0]);
                ...
                $('#fileDocument').change(function(e) {
                    ...
                    //             boardCount = boardCount + 1;
                    //             var str =
                    //                 `<div id="canvasBoardDiv${boardCount}" class="canvasClass" style="width:100% !important;height:100% !important;"><canvas style="width:100% !important;height:100% !important;" id="canvasBoard${boardCount}"></canvas></div>`;
                ...
                function scaleAndPositionImage(canvasObj, imageObj) {
                    ...
                    canvasObj.setBackgroundImage(imageObj, canvasObj.renderAll.bind(canvasObj), {
                ...
                $('#ancUndo').click(function() {
                    ...
                    if (undoStack.length > 0) {
                        ...
                        for (var i = 0, len = size; i < len; i++) {
                            if (currentState.objects[i] && currentState.objects[i].type === 'image') {
                                currentState.objects[i].crossOrigin = currentState.objects[i].crossOrigin ||
                                    'anonymous';
                            }
                        }
                        if (currentState.backgroundImage) {
                            currentState.backgroundImage.crossOrigin = currentState.backgroundImage
                ...
                $("#ancDrawing").bind("click", function(event) {
                    $("#whiteboard").text("Free Online Whiteboard");
                ...
                $("#ancEditor").bind("click", function(event) {
                    $("#whiteboard").text("Online Text Editor");
                ...
                function handleMouseDownEvent(data) {
                    ...
                    } else if (event == DRAWING_SELECT_TOOL || event == DRAWING_IMAGE_TOOL || event ==
                        DRAWING_TEXT_TOOL) {
                        isDrawing = 1;
                        $("#eraser-cursor").css({
                            display: "none"
                ...
                function handleObjectSelectedEvent(data) {
                    var event = data.drawingTool;
                    if (event && (event == DRAWING_SELECT_TOOL || event == DRAWING_IMAGE_TOOL || event ==
                            DRAWING_TEXT_TOOL)) {
                        gcanvas.forEachObject(function(obj) {
                ...
                function handleMouseMoveEvent(data) {
                    var pointer = data.pointer;
                    var event = data.drawingTool;
                    if (isDrawing && event && (event == DRAWING_SELECT_TOOL || event == DRAWING_IMAGE_TOOL || event ==
                            DRAWING_TEXT_TOOL)) {
                        gcanvas.forEachObject(function(obj) {
                            if (obj.uuid && obj.uuid === data.uuid) {
                                //                   gcanvas.bringToFront(obj);
                ...
                $('#ancDwnJson').click(function() {
                    ...
                    canvasData = "data:text/json;charset=utf-8," + encodeURIComponent(JSON.stringify(
                        canvasData));
                    var a = $("<a>").attr("href", canvasData).attr("download", 'whiteboard-' + dimgCount +
                        '.board').appendTo("body");
                    a[0].click();
                    a.remove();
                    dimgCount++;
                ...
                $('#fileJson').change(function(e) {
                    ...
                    inputs.append('file', $("#fileJson").prop("files")[0]);
                    var url = "{{ url('api/upload-board-file') }}";
                    $('.wrapLoader').show();
                    $.ajax({
                        url: url,
                        method: "POST",
                        ...
                        gcanvas.loadFromJSON(response, gcanvas.renderAll.bind(gcanvas));
                        gcanvas.forEachObject(function(obj) {
                            if (obj.type == 'path') {
                                obj.set({
                                    hasControls: false,
...
<script src="{{ asset('white-board-assets/text-editor.min.js') }}"></script>
<script src="{{ asset('white-board-assets/fabric.min.js') }}"></script>
<script src="{{ asset('white-board-assets/fontawesome-kit.min.js') }}" crossorigin="anonymous"></script>

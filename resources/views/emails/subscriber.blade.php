...
<head>
	...
	<title>ResumeSathi - Thank you for subscribing</title>
							...
							<tr>
								<td style="padding: 35px 15px 55px 15px; box-sizing: border-box; vertical-align: top; background-color: #fff; border: 1px solid #D8D8D8; border-radius: 8px;">
									<div style="text-align: center; padding-bottom: 12px; padding-top:12px; background-color:aliceblue; border-radius:10px">
										<img src="{{ asset('email-assets/ResumeSathi-logo-email.png') }}" style="max-width: 100px;" alt="ResumeSathi subscriber">
									</div>
									...
									<div style="padding: 10px 50px;">
										...
										<p style="font-family: 'Open Sans', sans-serif; font-weight: 400; font-size: 16px; line-height:  22px; margin-top: 0; color: #000;text-align:center">Thank you for subscribing to our newsletter of <a href="https://www.ResumeSathi.com/">ResumeSathi.com</a>!</p>
									</div>
									<div style="text-align: center; padding-top: 10px; max-width: 375px; margin: 0 auto; padding-bottom: 5px;">
										...
										<p style="font-family: 'Open Sans', sans-serif; font-weight: 400; color: #616161; font-size: 15px; line-height: 21px;margin-bottom:15px">By subscribing to our newsletter, you will receive notifications about recent articles, tutorials, snippets, blogs, and much more.</p>
                                            <p style="font-family: 'Open Sans', sans-serif; font-weight: 400; color: #616161; font-size: 15px; line-height: 21px;">Thank you for choosing ResumeSathi as your source for all things tech. We're excited to embark on this knowledge journey with you!</p>
									</div>
									<div style="text-align: center; margin-top: 20px;">
										<a target="_blank" href="https://www.facebook.com/ResumeSathi/"><img src="{{ asset('email-assets/fb.png') }}" alt="fb"></a>&nbsp;&nbsp;
										<a target="_blank" href="https://www.instagram.com/ResumeSathi/"><img src="{{ asset('email-assets/insta.png') }}" alt="insta"></a>&nbsp;&nbsp;
										<a target="_blank" href="https://in.pinterest.com/ResumeSathi/"><img src="{{ asset('email-assets/pin.png') }}" alt="Pinterest"></a>&nbsp;&nbsp;
										{{-- <a target="_blank" href="https://www.apkfiles.com/apk-608925/ResumeSathi"><img src="{{ asset('email-assets/store.png') }}" alt="App"></a>&nbsp;&nbsp; --}}
									</div>
									<div style="text-align: center; margin-top: 20px;">
										<a href="https://www.ResumeSathi.com/" style="font-family: 'Open Sans', sans-serif; font-weight: 700; font-size: 16px; line-height:  22px; color: #fff; text-decoration: none; display:  inline-block; padding:  14px 50px; text-align:center; background: linear-gradient(110.01deg, #0004ff 1.85%, #00ff22 99.65%); box-sizing: border-box; border-radius: 5px;">Start Learning</a>
									</div>
								</td>
							</tr>
							<tr>
								<td>
									<p style="font-family: 'Open Sans', sans-serif; font-weight: 400; font-size: 13px; line-height: 18px; color: #7C96A4; padding:  15px; text-align:center; margin-top: 20px;">© <?php echo date("Y"); ?> ResumeSathi</p>
								</td>
							</tr>
						</table>
					</td>
